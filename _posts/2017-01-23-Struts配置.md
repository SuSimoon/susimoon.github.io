...
title:  "Struts2-配置"
date:   2017-01-23
excerpt: "本篇介绍了Struts2的配置文件的加载顺序、Action的配置、常量配置、struts.xml文件的分离以及局部与全局结果页面的配置方式"
tag:
- Java 
- Struts2
- SSH框架
...
## <center>局部与全局结果页面</center>


### 局部页面:

```xml
<action name="result" class="cn.xsw.struts2.demo.ResultAction">
	<!-- 局部结果:当前Action使用 -->
